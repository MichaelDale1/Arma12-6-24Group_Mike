resource "aws_launch_template" "app1_LT_80-Hong-Kong" {
  ...
  vpc_security_group_ids = [aws_security_group.app1-sg01-servers-TG01-SG01-80-Hong-Kong.id]
...
/*
resource "aws_launch_template" "app2_LT_443-Hong-Kong" {
  provider = aws.HongKong
  ...
  vpc_security_group_ids = [aws_security_group.app1-sg03-secure-servers-TG02-443-Hong-Kong.id]
