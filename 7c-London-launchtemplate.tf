resource "aws_launch_template" "app1_LT_80-London" {
  ...
  vpc_security_group_ids = [aws_security_group.app1-sg01-servers-TG01-SG01-80-London.id]
...
/*
resource "aws_launch_template" "app2_LT_443-London" {
  provider = aws.london
  ...
  vpc_security_group_ids = [aws_security_group.app1-sg03-secure-servers-TG02-443-London.id]
