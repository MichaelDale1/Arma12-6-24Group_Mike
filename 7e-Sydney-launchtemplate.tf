resource "aws_launch_template" "app1_LT_80-Sydney" {
  ...
  vpc_security_group_ids = [aws_security_group.app1-sg01-servers-TG01-SG01-80-Sydney.id]
...
/*
resource "aws_launch_template" "app2_LT_443-Sydney" {
  provider = aws.sydney
  ...
  vpc_security_group_ids = [aws_security_group.app1-sg03-secure-servers-TG02-443-Sydney.id]
