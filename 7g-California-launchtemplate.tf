resource "aws_launch_template" "app1_LT_80-California" {
  ...
  vpc_security_group_ids = [aws_security_group.app1-sg01-servers-TG01-SG01-80-California.id]
...
/*
resource "aws_launch_template" "app2_LT_443-California" {
  provider = aws.California
  ...
  vpc_security_group_ids = [aws_security_group.app1-sg03-secure-servers-TG02-443-California.id]
