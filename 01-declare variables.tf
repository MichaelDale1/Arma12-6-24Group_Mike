...
variable "tokyo_naming_convention" {
...
variable "vpc_name_loop" {
    description = "vpc name for resource creation loops"
    type =list (string)
}


variable "vpc_name_loop2" {
    description = "vpc name for resource creation loops"
    type =list (string)
}
...
output "content" {
  value = var.naming_convention3.Tokyo.vpc_id
}
